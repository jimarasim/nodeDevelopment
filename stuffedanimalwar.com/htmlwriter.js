...
function writeStuffedAnimalWarChoices(){
    ...
    document.write("<br />");
    document.write("<input type=\"radio\" id=\"stuffedanimalwarcustom\" name=\"sawstyle\" value=\"custom\" >SPECIFY IMAGE LINK (e.g.:http://website.com/image.jpg AND also any .jpeg, .png, .gif)");
